...
const IBScreen = ({ navigation }) => {
  ...
  const copyReferralLink = async () => {
    if (ibProfile?.referralCode) {
      const link = `https://trade.vediex.com/user/signup?ref=${ibProfile.referralCode}`;
          ...
          <>
            ...
            <View style={styles.referralLinkCard}>
              ...
              <Text style={styles.referralLinkText} numberOfLines={1}>
                https://trade.vediex.com/user/signup?ref={ibProfile?.referralCode}
              </Text>
