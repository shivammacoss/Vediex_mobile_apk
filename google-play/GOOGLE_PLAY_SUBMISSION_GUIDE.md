# Complete Google Play Store Submission Guide for Vediex
...
1. **Privacy Policy** → `privacy-policy.html`
   - Host at: `https://vediex.com/privacy-policy`
   
2. **Terms of Service** → `terms-of-service.html`
   - Host at: `https://vediex.com/terms-of-service`

3. **Account Deletion Policy** → `account-deletion-policy.html`
   - Host at: `https://vediex.com/account-deletion`

### How to host on your server:
```bash
# Copy HTML files to frontend public directory
cp privacy-policy.html ~/vediex/frontend/public/privacy-policy.html
cp terms-of-service.html ~/vediex/frontend/public/terms-of-service.html
cp account-deletion-policy.html ~/vediex/frontend/public/account-deletion.html
...
- Should show: App name "Vediex", trading theme, professional look
...
2. Click "Create app"
3. Fill in:
   - **App name:** Vediex - Trading Platform
...
#### Privacy Policy
- Enter URL: `https://vediex.com/privacy-policy`
...
#### Account Deletion
- Enter URL: `https://vediex.com/account-deletion`
...
4. Add release notes:
   ```
   Initial release of Vediex Trading Platform
